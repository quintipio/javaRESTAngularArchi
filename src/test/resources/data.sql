...
INSERT INTO UTILISATEUR (ID, CREATED_DATE,LAST_MODIFIED_DATE,VERSION,EMAIL,ACTIVE,LANGUE,LINK_ACTIVATION, LINK_RESET_PASSWORD,MOTDEPASSE,NOM, PRENOM,SSO) VALUES
  (1,'2017-01-01 00:00:00',null,'2017-01-01 00:00:00','superadmin@superadmin.fr',TRUE,'fr',null,null,'$2a$10$Wb1.dzDIMJr0H3x29y6QkeuRhugm1sTZco4RNpqxoMmN2qP2YguP2','admin','admin','admin.admin');
